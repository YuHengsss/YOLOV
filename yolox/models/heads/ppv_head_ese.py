...
class PPYOLOEHead(nn.Module):
    ...
    def __init__(self,
        ...
        for i in range(len(in_channels)):
            ...
            self.cls_convs2.append(
                ESEAttn(self.width, self.width, act=act)
                )
    ...
    def forward(self, feats, targets=None, imgs=None):
        ...
        for k, (cls_conv, reg_conv, cls_conv2, stride_this_level, x) in enumerate(
            ...
            cls_feat2 = cls_conv2(x, avg_feat) + x
        ...
        #     return self.postprocess_single_img(decode_res,self.num_classes)
        #return decode_res
        ...
        if self.use_score:
            trans_cls = self.trans(features_cls,features_reg,cls_scores,fg_scores)
        else:
