...
from yolox.models.ablation_trans import Trans_yolov
...
class PPYOLOEHead(nn.Module):
    ...
    def __init__(self,
        ...
        self.linear_pred = nn.Linear(int(self.width), 31)
        self.n_anchors = 1
        ...
        self.trans = Trans_yolov(in_dim=self.width,depth=3,nums_heads=heads)
    ...
    def forward(self, feats, targets=None, imgs=None):
        ...
        trans_cls = self.trans(features_cls)
