...
from yolox.models.ablation_trans import MSA_ours_nr
...
class PPYOLOEHead(nn.Module):
    ...
    def __init__(self,
        ...
        self.trans = MSA_ours_nr(dim=self.width,out_dim=4*self.width,num_heads=heads,attn_drop=drop)
    ...
    def forward(self, feats, targets=None, imgs=None):
        ...
        trans_cls = self.trans(features_cls, cls_scores,)
