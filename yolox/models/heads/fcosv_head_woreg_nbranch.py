...
from yolox.models.post_trans import MSA_yolov_valina
...
class FCOSHead(torch.nn.Module):
    def __init__(self,
        ...
        self.n_anchors = 1
        self.use_l1 = False
        self.trans = MSA_yolov_valina(dim=self.width, out_dim=4 * self.width, num_heads=4, attn_drop=0,scale=25)
    ...
    def forward(self, xin, labels=None, imgs=None):
        ...
        trans_cls = self.trans(features_cls, features_reg, cls_scores, None)
