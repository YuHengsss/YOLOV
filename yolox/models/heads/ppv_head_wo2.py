...
from yolox.models.ablation_trans import Trans_yolov_scaled_linear
...
class PPYOLOEHead(nn.Module):
    ...
    def __init__(self,
        ...
        self.trans = Trans_yolov_scaled_linear(in_dim=self.width,nums_heads=heads,drop_rate=drop,scale=25)
